...
module RakeTasksApp
  class Application < Hanami::Application
    configure do
      ...
      #
      security.content_security_policy "default-src 'none'; script-src 'self'; connect-src 'self'; img-src 'self'; style-src 'self'; font-src 'self'; object-src 'self'; frame-src 'self'"
